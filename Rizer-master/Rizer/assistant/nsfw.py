...
@senzir.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@senzir.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@senzir.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
